...
import { PopularCardsGrid } from '@/ui/podcasts/components/popular-cards-grid';
...
describe('PopularCardsGrid', () => {
  ...
  it('renders the container', () => {
    renderWithRouter(<PopularCardsGrid data={mockData} />);
  ...
  it('renders empty when data is empty array', () => {
    renderWithRouter(<PopularCardsGrid data={[]} />);
