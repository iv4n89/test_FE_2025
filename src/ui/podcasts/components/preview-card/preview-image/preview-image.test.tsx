...
import { PreviewImage } from '@/ui/podcasts/components/preview-card/preview-image/preview-image';

describe('PopularCardImage', () => {
  it('renders image with correct src and alt', () => {
    render(<PreviewImage src="test-image.jpg" alt="Test Alt" testid="image" />);
