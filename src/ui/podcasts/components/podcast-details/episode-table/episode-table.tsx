...
import { formatDate } from '@/ui/common/util/format-date/format-date';
import { formatDuration } from '@/ui/common/util/format-duration/format-duration';
...
export const EpisodeTable = ({ episodes, podcastId }: Props) => {
  return (
    <ShadowedBox>
